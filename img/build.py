...
if __name__ == '__main__':
    ...
    lines = [Sparkline(data, color="purple", plot_style=style) for style in OneLinePlotStyle]
    ...
    console.print()
    console.save_svg("sparkline-table.svg", title="Sparkline Table Example", theme=THEME)
